...
class Assignment1:
    ...
    def __init__(self):
        ...
        # Create semaphores
        # Counting semaphore: initial value = queue max length 5, control empty slots
        self.semaphore = threading.Semaphore(5)
        # Binary semaphore: initial value = 1, ensure mutual exclusion
...
class machineThread(threading.Thread):
    ...
    # Acquiring the Counting Semaphore
    def isRequestSafe(self, id):
        print(f"Machine {id} Checking availability")
        # Acquire counting semaphore (wait for an available queue slot)
    ...
    # after inserting the print request
